    ...
    <main className="min-h-screen bg-slate-100 text-slate-950">
      ...
      {screen === "attract" && (
        ...
        <button
          ...
          className="flex min-h-screen w-full items-center justify-center bg-gradient-to-br from-blue-950 via-slate-950 to-blue-800 text-white"
        >

          <div className="text-center">

            <div className="mx-auto flex h-40 w-40 items-center justify-center rounded-full bg-blue-700 text-6xl font-black shadow-2xl">
              TPA
            </div>
            ...
            <div className="mt-12 rounded-full bg-white px-10 py-5 text-2xl font-bold text-blue-950">
                ...
                <div className="mt-6 grid gap-6 md:grid-cols-2">
                  ...
                  >
                    ...
                    <h2 className="mt-5 text-3xl font-black text-slate-950">
                      Achats accessoires divers
                    </h2>

                    <p className="mt-4 text-lg text-slate-600">
                      Ampoules, liquides, entretien et petits accessoires.
                    </p>
